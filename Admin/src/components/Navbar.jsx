...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`navbar navbar-expand border-bottom shadow-sm px-4 ${darkMode ? 'bg-dark navbar-dark' : 'bg-white navbar-light'}`}>
        ...
        <>
          ...
          >
            ...
            <div className="flex-grow-1 p-2 overflow-auto">
              <a href="#" className="d-flex align-items-center gap-3 text-white text-decoration-none p-3 rounded hover-bg-secondary">
                <User size={20} />
              ...
              <a href="#" className="d-flex align-items-center gap-3 text-white text-decoration-none p-3 rounded hover-bg-secondary">
                <Key size={20} />
                <span className='text-warning'>Change Password</span>
              </a>

              <hr className="border-secondary my-2" />

              <a href="#" className="d-flex align-items-center gap-3 text-danger text-decoration-none p-3 rounded hover-bg-secondary">
                <LogOut size={20} />
